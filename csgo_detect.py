...
from csgo_utils.grab_screen import GrabScreen
from csgo_utils.autoaim import MouseController
import numpy as np
...
def parse_opt():
    ...
    parser.add_argument('--name', default='csgo', help='save results to project/name')
